...
var file_p4_v1_p4data_proto_goTypes = []any{
...
func file_p4_v1_p4data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_p4_v1_p4data_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*P4Data); i {
			case 0:
				return &v.state
			case 1:
		...
		file_p4_v1_p4data_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_p4_v1_p4data_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_p4_v1_p4data_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_p4_v1_p4data_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_p4_v1_p4data_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_p4_v1_p4data_proto_msgTypes[6].Exporter = func(v any, i int) any {
	...
	file_p4_v1_p4data_proto_msgTypes[0].OneofWrappers = []any{
